...
import { Capacitor } from "@capacitor/core"; // 👈 استيراد الأداة

export default function InstallBanner() {
  const [showBanner, setShowBanner] = useState(false);

  useEffect(() => {
    // 👈 التحقق: إذا كان يعمل كتطبيق (android أو ios) لا تظهر شيئاً
  ...
  // إذا كان تطبيقاً أو تم إغلاقه، لن يتم رندر المكون
